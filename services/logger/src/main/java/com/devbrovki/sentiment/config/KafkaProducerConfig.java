...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, SentimentResult> producerFactorySentiment() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    public KafkaTemplate<String, SentimentResult> kafkaTemplateSentiment() {
        return new KafkaTemplate<>(producerFactorySentiment());
    }
}
